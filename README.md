...
### v10 schema
No previous version continues to be updated. This version now reports a cflinuxfs2-release version. In `compatibility-v10.csv`, we track the following information:
